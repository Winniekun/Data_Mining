...
attribute_path = "./data/attribute.csv"
...
# print("non_numeric_attributes", non_numeric_attributes)
# print("numeric_attributes", numeric_attributes)
# print("numeric_values", numeric_attributes)
# print("labels", labels)
...
for i in range(0, len(labels)):
    ...
    if i % 10 == (base + 2) % 10 or i % 10 == (base + 5) % 10 or i % 10 == (base + 7) % 10:
        ...
        train_set.append(i)
print("划分的训练集长度为: ", len(test_set))
print("划分的测试集长度为: ", len(train_set))
